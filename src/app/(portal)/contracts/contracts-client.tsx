...
interface Props {
  ...
  userId: string;
  /** Read-only admin preview: hides signing UI entirely. */
  preview?: boolean;
}

export function ContractsClient({ initialContracts, userId, preview = false }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {!preview && <Topbar title="Contracts" subtitle="Review and sign your agreements" userId={userId} />}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 flex-shrink-0">
                    ...
                    {!preview && contract.status === "pending" && (
                      <Button
                        size="sm"
